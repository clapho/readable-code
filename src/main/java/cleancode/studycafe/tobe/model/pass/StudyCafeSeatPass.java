...
public class StudyCafeSeatPass implements StudyCafePass {
    ...
    private StudyCafeSeatPass(StudyCafePassType passType, int duration, int price,
        double discountRate) {
    ...
    public boolean isSameDurationType(StudyCafeLockerPass lockePass) {
        return lockePass.isSamePassType(this.passType)
            && lockePass.isSameDuration(this.duration);
    }
